#ifndef GALLOCY_HEAPLAYERS_MYHASHMAP_H_
...
class MyHashMap {
 public:
  explicit MyHashMap(int size = INITIAL_NUM_BINS)
    : num_bins(size) {
  ...
  void set(Key k, Value v) {
    int binIndex = reinterpret_cast<unsigned int>(hash(k) % num_bins);
...
#endif  // GALLOCY_HEAPLAYERS_MYHASHMAP_H_
